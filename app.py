...
<div class="main-header">
    ...
    <p>Tác giả: Lệnh Thị Thu - Trường Tiểu học Vĩnh Hảo - ĐT: 0343336836
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lệnh Thị Thu - Trường Tiểu học Vĩnh Hảo - ĐT:0343336836</div>", unsafe_allow_html=True)
